...
void Java_foam_nebogeo_earlobes_Earlobes_setParam(JNIEnv* env, jclass clazz,
                                                       jint which, jint amount)
{
    set_param(which,amount);
}



// create the engine and output mix objects
void Java_foam_nebogeo_earlobes_Earlobes_createEngine(JNIEnv* env, jclass clazz)
{
    SLresult result;

    init(RECORDER_FRAMES);
